...
public class PomRenderer {
	...
	public static void writeHeaderToPomFile(final FileWriter fileWritter, 
			final String projectName) throws IOException {
		
		fileWritter.write(String.format(
				"<project xmlns=\"" + XmlConstants.POM_DEFAULT_NAMESPACE + "\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" \n" +
	...
	public static void writeDependeciesToPomFile(final FileWriter fileWritter, 
			final List<Dependency> dependencies) throws IOException {
